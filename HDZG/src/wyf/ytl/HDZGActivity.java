...
public class HDZGActivity extends Activity {
	...
	public HelpView helpView;//帮助界面
	public SoundView soundView;//刚开始时选择是否开启声音的界面
	public SoundManageView soundManageView;//声音设置界面
	public ScreenRollView screenRoll;//竹简滚屏界面
	public AboutView aboutView;//关于界面
	...
	public View currentView = null;//当前的View
